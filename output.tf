...
output "elasticache_url" {
  ...
  value = "${var.elasticache_number_cache_clusters == 1 ? aws_elasticache_cluster.elasticache.0.cache_nodes.0.address : aws_elasticache_cluster.elasticache.0.cache_nodes.0.address }"
}
